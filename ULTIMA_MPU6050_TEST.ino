...
//////////
  ...
  tft1.fillCircle (xold, yold, 5, WHITE);    
  }
/// inital color =1 (blue), 2=red, 3=yellow, 4=green, 5=black
  switch(color){
    case 1:
    tft1.fillCircle (xpos, ypos, 5, BLUE);
    break;
    case 2:
    tft1.fillCircle (xpos, ypos, 5, RED);
    break;
    case 3:
    tft1.fillCircle (xpos, ypos, 5, YELLOW);
    break;
    case 4:
    tft1.fillCircle (xpos, ypos, 5, GREEN);
    break;
    case 5:
    tft1.fillCircle (xpos, ypos, 5, BLACK);
    break;
    default:
    ;
  }
