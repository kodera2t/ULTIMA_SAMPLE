...
//      with Arduino Due.
// Nov 2016 for ULTIMA I2C test by kodera2t
//
...
/// initial position of blue dot (48,32)
  xpos=48;
  ypos=32;
...
// SerialUSB.println(F("InvenSense MPU-6050"));
// SerialUSB.println(F("June 2012"));
...
//////////
  ...
  tft1.fillCircle (xold, yold, 3, WHITE);    
  }
  }
/// inital color =1 (blue), 2=red, 3=yellow, 4=green, 5=black
  switch(color){
    case 1:
    tft1.fillCircle (xpos, ypos, 3, BLUE);
    break;
    case 2:
    tft1.fillCircle (xpos, ypos, 3, RED);
    break;
    case 3:
    tft1.fillCircle (xpos, ypos, 3, YELLOW);
    break;
    case 4:
    tft1.fillCircle (xpos, ypos, 3, GREEN);
    break;
    case 5:
    tft1.fillCircle (xpos, ypos, 3, BLACK);
    break;
    default:
    ;
  }
